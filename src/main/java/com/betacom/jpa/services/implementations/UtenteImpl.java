...
public class UtenteImpl implements IUtenteInterfaces{
	...
	public Utente updateUtente(UtenteReq req) throws AcademyException {
	    ...
	    if (req.getUsername() != null) utente.setUsername(req.getUsername());
	    if (req.getPassword() != null) utente.setPassword(req.getPassword());
	    if (req.getEmail() != null) utente.setEmail(req.getEmail());
	    if (req.getRole() != null) utente.setRole(req.getRole());
